...
let q;
    ...
    async function getSearch(q){
        ...
        resultsEl.addEventListener('click', ()=>{
            ...
            let cajaIconClose = document.createElement('div')
            cajaIconClose.classList.add('caja-icon-close')
            cajaIconClose.appendChild(imagenCerrar)
            cajaExpandir.appendChild(cajaIconClose)
            // agrego imagen
            let imagen = document.createElement('img')
            imagen.src = resultado.data[2].images.downsized.url;
            cajaExpandir.appendChild(imagen);
            imagen.classList.add('imagen-popup');
            ...
            imgBtnFav.classList.add('img-botonFav');
            let imgBtnFavActive = document.createElement('img');
            imgBtnFavActive.src = 'imagenes/icon-fav-active.svg';
            imgBtnFavActive.alt = 'icono favoritos';
            imgBtnFavActive.classList.add('img-botonFav-active');
            imgBtnFavActive.style.display ='none';
            imgBtnFav.addEventListener('click', ()=>{
                    imgBtnFav.style.display = "none";
                    imgBtnFavActive.style.display = "block";
                });
                imgBtnFavActive.addEventListener('click', ()=>{
                    imgBtnFav.style.display = "block";
                    imgBtnFavActive.style.display = "none";
                })
            ...
            imgBtndownload.classList.add("img-download");
            botonesCaja.append(imgBtnFav, imgBtnFavActive, imgBtndownload);
            ...
            // CAJA USER/ICONOS 
            let cajaDatosGenerales = document.createElement('div')
            cajaDatosGenerales.classList.add('caja-datos-generales')
            cajaDatosGenerales.append(botonesCaja, datos)
            cajaExpandir.appendChild(cajaDatosGenerales)
